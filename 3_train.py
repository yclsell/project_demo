...
PIPELINE_CONFIG_PATH = os.getcwd() + "/" + "faster_rcnn_inception_v2_coco.config"
...
MODEL_DIR = os.getcwd() + "/" + "faster_rcnn_inception_v2_coco_2018_01_28"
...
def checkIfNecessaryPathsAndFilesExist():
    ...
    missingModelMessage = "Did you download and extract the model from the TensorFlow GitHub models repository detection model zoo?" + "\n" + \
                          ...
                          "faster_rcnn_inception_v2_coco is recommended"
